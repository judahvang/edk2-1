...
//#  include <stdlib.h>
#  define ROR32(x, nBits)  lrotr((x),(nBits))
#  define ROL32(x, nBits)  lrotl((x),(nBits))
...
/* change endian */
#if defined(_MSC_VER)
#  define ENDIANNESS(x)   (((x & 0x000000FF) << 24) | ((x & 0x0000FF00) << 8)  | ((x & 0x00FF0000) >> 8)  | ((x & 0xFF000000) >> 24))
#  define ENDIANNESS32(x)  ENDIANNESS((x))
#  define ENDIANNESS64(x) ((x & 0x00000000000000FFULL) << 56) |  \
